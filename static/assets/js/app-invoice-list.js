...
$(function () {
  ...
  if (dt_invoice_table.length) {
    var dt_invoice = dt_invoice_table.DataTable({
      ...
      columnDefs: [
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            ...
            var $row_output = '<a href="#">' + $invoice_id + '</a>';
            return $row_output;
          }
        },
        {
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            return (
              ...
              '<a href="#" data-bs-toggle="tooltip" class="text-body" data-bs-placement="top" title="Preview Invoice"><i class="ti ti-eye mx-2 ti-sm"></i></a>' +
              '<div class="dropdown">' +
      ...
      buttons: [
        {
          text: '<i class="ti ti-plus me-md-1"></i><span class="d-md-inline-block d-none">Create Order</span>',
