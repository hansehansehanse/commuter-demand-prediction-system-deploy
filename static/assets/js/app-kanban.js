    ...
    },
    {
      ...
      "item": [
        ...
        },
        {
          ...
          "comments": "18",
          "badge-text": "Images",
          "image": "../../assets/img/elements/16.jpg",
          "badge": "warning",
          "due-date": "2 April",
          "attachments": "10",
          "assigned": [
      ...
      : images
        ...
        .map(function (img, index, arr) {
          ...
          return (
            ...
            "'" +
            '>' +
            "<span class='avatar-initial rounded-circle bg-label-" + $state + " rounded-circle pull-up' style='display: flex; align-items: center; justify-content: center;'>" +
            $initials +
            "</span>" +
            '</div>'
          );
